...
class MetaBoxManager {
  ...
  public function enqueueMediaLibrary($hook) {
      if ('post.php' == $hook || 'post-new.php' == $hook) {
          wp_enqueue_media();
          wp_enqueue_style('wp-color-picker'); // Enqueue color picker style
          wp_enqueue_script('wp-color-picker'); // Enqueue color picker script
      }
  }
      ...
      <script>
          jQuery(document).ready(function ($) {
              ...
              function renderComponentAccordion(component) {
                  ...
                  initializeColorPickers(component.instance_id); // Initialize color pickers
              }
              ...
              function renderComponentFields(component, index) {
                  ...
                  component.fields.forEach(function(field) {
                      ...
                      if (field.type === 'text') {
                          ...
                          `;
                      } else if (field.type === 'color') { // NEW: Color field
                          fieldsHtml += `
                              <input type="text" 
                                     id="ccc_field_${component.instance_id}_${field.id}" 
                                     name="${fieldName}" 
              ...
              function renderRepeaterItem(parentInstanceId, parentFieldId, itemIndex, itemData, nestedFieldDefinitions, nestingLevel) {
                  ...
                  nestedFieldDefinitions.forEach(function(nestedField) {
                      ...
                      if (nestedField.type === 'text') {
                          ...
                          `;
                      } else if (nestedField.type === 'color') { // NEW: Nested Color field
                          fieldsHtml += `
                              <input type="text" 
                                     class="ccc-nested-field-input ccc-color-picker" 
                                     data-nested-field-type="color"
                                     value="${nestedFieldValue}" />
                          `;
              ...
              function renderDeeplyNestedRepeaterItem(grandparentInstanceId, grandparentFieldId, parentItemIndex, nestedRepeaterName, deepItemIndex, deepItemData, deeplyNestedFieldDefinitions, nestingLevel) {
                  ...
                  deeplyNestedFieldDefinitions.forEach(function(deepNestedField) {
                      ...
                      if (deepNestedField.type === 'text') {
                          ...
                          `;
                      } else if (deepNestedField.type === 'color') { // NEW: Deeply Nested Color field
                          fieldsHtml += `
                              <input type="text" 
                                     class="ccc-nested-field-input ccc-color-picker" 
                                     data-nested-field-type="color"
              ...
              function renderTripleNestedRepeaterItem(greatGrandparentInstanceId, greatGrandparentFieldId, grandparentItemIndex, grandparentNestedFieldName, parentItemIndex, parentNestedFieldName, tripleItemIndex, tripleItemData, tripleNestedFieldDefinitions, nestingLevel) {
                  ...
                  tripleNestedFieldDefinitions.forEach(function(tripleNestedField) {
                      ...
                      if (tripleNestedField.type === 'text') {
                          ...
                          `;
                      } else if (tripleNestedField.type === 'color') { // NEW: Triple Nested Color field
                          fieldsHtml += `
                              <input type="text" 
                                     class="ccc-nested-field-input ccc-color-picker" 
                                     data-nested-field-type="color"
              ...
              function initializeRepeaterFields(instanceId) {
                  ...
                  $(document).off('click', `.ccc-repeater-add`).on('click', `.ccc-repeater-add`, function() {
                      ...
                      initializeNestedColorPickers(newItem); // Initialize color pickers for new nested items
                  ...
                  // Initialize color pickers for all existing nested color fields
              ...
              // NEW: Initialize color pickers for top-level color fields
              function initializeColorPickers(instanceId) {
                  $(`.ccc-field-input[data-field-type="color"] input.ccc-color-picker`).each(function() {
                      $(this).wpColorPicker({
                          change: function(event, ui) {
                              // No need to trigger change for top-level fields, as they are directly saved
                          }
                      });
                  });
              }

              // NEW: Initialize color pickers for nested color fields
              function initializeNestedColorPickers($item) {
                  $item.find('.ccc-nested-field-input.ccc-color-picker').each(function() {
                      $(this).wpColorPicker({
                          change: function(event, ui) {
              ...
              $('.ccc-component-accordion').each(function(index) {
                  ...
                  initializeColorPickers(componentsData[index].instance_id); // Initialize color pickers for existing top-level fields
              });
          });
      </script>
      <?php
              ...
              <?php if ($fields) : ?>
                  <?php foreach ($fields as $field) : ?>
                      <div class="ccc-field-input" data-field-type="<?php echo esc_attr($field->getType()); ?>">
                          ...
                          <?php elseif ($field->getType() === 'color') : // NEW: Color field ?>
                              <input type="text" 
                                     id="ccc_field_<?php echo esc_attr($instance_id . '_' . $field->getId()); ?>"
                                     name="<?php echo esc_attr($field_name); ?>"
                                     class="ccc-color-picker"
          ...
          <div class="ccc-repeater-item-fields">
              ...
              ?>
                  <div class="ccc-nested-field" 
                      ...
                      <?php elseif ($nested_field['type'] === 'color') : // NEW: Nested Color field ?>
                          <input type="text" 
                                 class="ccc-nested-field-input ccc-color-picker" 
                                 data-nested-field-type="color"
                                 value="<?php echo esc_attr($nested_field_value); ?>" />
          ...
          <div class="ccc-repeater-item-fields">
              ...
              ?>
                  <div class="ccc-nested-field" 
                      ...
                      <?php elseif ($deep_nested_field['type'] === 'color') : // NEW: Deeply Nested Color field ?>
                          <input type="text" 
                                 class="ccc-nested-field-input ccc-color-picker" 
                                 data-nested-field-type="color"
                                 value="<?php echo esc_attr($deep_nested_field_value); ?>" />
          ...
          <div class="ccc-repeater-item-fields">
              ...
              ?>
                  <div class="ccc-nested-field" 
                      ...
                      <?php elseif ($triple_nested_field['type'] === 'color') : // NEW: Triple Nested Color field ?>
                          <input type="text" 
                                 class="ccc-nested-field-input ccc-color-picker" 
                                 data-nested-field-type="color"
                                 value="<?php echo esc_attr($triple_nested_field_value); ?>" />
  ...
  public function saveComponentData($post_id, $post) {
      ...
      foreach ($field_values as $instance_id => $instance_fields) {
          ...
          foreach ($instance_fields as $field_id => $value) {
              ...
              } elseif ($field_obj->getType() === 'color') { // NEW: Sanitize color field
                  $value_to_save = sanitize_hex_color($value_to_save) ?: sanitize_text_field($value_to_save);
              } else {
      ...
      foreach ($data as $item) {
          ...
          foreach ($nested_field_definitions as $nested_field_def) {
              ...
              if (isset($item[$field_name])) {
                  ...
                  } elseif ($field_type === 'color') { // NEW: Sanitize nested color field
